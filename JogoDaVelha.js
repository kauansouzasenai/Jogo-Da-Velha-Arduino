function main() {
  ...
  do {
    ...
    if (linha < 3 && coluna < 3) {
      ...
      if (getValArrayInt(linha, coluna, tabuleiro, 3) == 0) {
        ...
        if (
          (tabuleiro[0] == jogadorDaVez &&
            tabuleiro[1] == jogadorDaVez &&
            tabuleiro[2] == jogadorDaVez) ||
          (tabuleiro[3] == jogadorDaVez &&
            tabuleiro[4] == jogadorDaVez &&
        ...
        console.log(
          "A posição que você tentou inserir uma peça já esta ocupada!!!"
        );
      }
      ...
      console.log(
        "Linha ou coluna inválida!!! Linha: " + linha + "; Coluna: " + coluna
      );
    }
  ...
  if (haVencedor) {
    console.log("O jogador " + jogadorDaVez + " venceu!!!");
  } else {
    console.log("EMPATE !!! VELHA !!!");
  }
}
...
function imprimeTabuleiro(t) {
  console.log(t[0].ToString() + t[1] + t[2]);
  console.log(t[3].ToString() + t[4] + t[5]);
  console.log(t[6].ToString() + t[7] + t[8]);
}
